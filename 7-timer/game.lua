...
function create_game(level_name)
  ...
  sonic=create_sonic()
  the_level = create_level(1200,550,350,create_color(220,220,220,255))
  ...
  background[1]=create_level(1200,525,350,create_color(180,180,180,255))
  background[2]=create_level(1200,535,250,create_color(130,130,130,255))
